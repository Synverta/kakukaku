...
## 端口规划
- `5000` — nginx，前端静态文件 + `/api`、`/uploads` 反向代理
- `5001` — kakukaku-server（Express + PostgreSQL）
...
curl -fsS http://127.0.0.1:5000/api/health   # 经 nginx
curl -fsS http://127.0.0.1:5000/             # 站点首页
```